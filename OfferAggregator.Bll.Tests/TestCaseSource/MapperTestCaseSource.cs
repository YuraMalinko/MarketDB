...
namespace OfferAggregator.Bll.Tests.TestCaseSource
{
    public class MapperTestCaseSource
    {
        ...
        public static IEnumerable MapStocksWithProductModelToStocksDtoWithProductNameTestCaseSource()
        {
        ...
        public static IEnumerable MapStocksDtoWithProductNameToStocksWithProductModelTestCaseSource()
        {
            StocksDtoWithProductName baseStockDto = new StocksDtoWithProductName
            {
                Amount = 100,
                ProductId = 10,
                Name = "oneProduct"
            ...
            StocksWithProductModel exepectedStockModel = new StocksWithProductModel
            {
                Amount = 100,
                ProductId = 10,
                Name = "oneProduct"
